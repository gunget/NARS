...
export type dummyPlaceType = {
  ...
  hotels?: dummyHotelType[]
}

export type dummyCountryType = {
  id: number
  //DashBoard에서 useState초기값을 여러개로 잡기 위해 있어도 되고 없어도 되는 값으로 아래 3개 넣음
  name?: string
  image: ImageSourcePropType //?를 넣으면 image source에넣을때 type이 undefined가 되면서 에러남
  places: dummyPlaceType[]
}

export type dummyCountriesType = dummyCountryType[]

export const countries: dummyCountriesType = [
  {
    id: 1,
    name: 'Malaysia',
